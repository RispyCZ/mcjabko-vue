<template>
    ...
    <ol class="list-decimal">
        ...
        <li>Od všech uživatelů je očekáván respekt k infrastruktuře serveru <ol>
        ...
        <li>Každý hráč ručí za zabezpečení svého uživatelského účtu! <ol>
    ...
    <ol>
        <li>Jakýkoliv pokyn člena Admin teamu (Majitel, Spolumajitel, Hlavní admin, Admin, Support či Zkušební support), musí být bezodkladně uposlechnut! <ol>
        ...
        <li>Je zakázáno používat modifikace hry, jež hráči poskytují značnou výhodu vůči ostatním hráčům. <ol>
        ...
        <li>Je zakázáno v chatu užívat vulgarismů, nevhodných slov a výrazů či sexuálních narážek! <ol>
        ...
        <li>Pokud dva hráči dospějí k dohodě, kdy si po vzájemném souboji v PvP aréně vrátí věci a jedna ze stran tuto dohodu poruší, jedná se o krádež a bude tak i trestána dle platných pravidel! <ol>
        ...
        <li>Každý hráč má nárok na plochu 300×300 blocků kolem jeho domu. Toto pásmo nesmí jiný hráč bez povolení narušit! <ol>
